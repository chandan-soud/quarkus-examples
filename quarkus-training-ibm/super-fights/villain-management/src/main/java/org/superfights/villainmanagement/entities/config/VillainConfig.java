...
@ApplicationPath("/")
@OpenAPIDefinition(info = @Info(title = "Villain API", description = "This API allows CRUD operations on a villain", version = "1.0.0", contact = @Contact(name = "Quarkus", url = "https://github.com/quarkusio")), servers = {
